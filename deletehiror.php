...
<body>
    ...
    if (isset($_SESSION['variable'])) {
        ...
        $sql_delete_hiror_data1 = "DELETE FROM hiror_data1 WHERE username = '$us'";
        $result_delete_hiror_data1 = $conn->query($sql_delete_hiror_data1);

        

        if ($result_delete_hiror_data1) {
