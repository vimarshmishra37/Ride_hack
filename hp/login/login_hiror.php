...
<head>
    ...
    <form method="post" action="login_hiror.php">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT * FROM hiror_data1 WHERE username = '$username' AND password = '$password'";
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: http://localhost/vedant/Project/hp/signup/hirordashboard.php");
