...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="signupworkerusernamepass.css">
</head>
<body>
    <div class="container">
        <h2>Worker Registration</h2>
        <form id="registrationForm" action="signupworkerusernamepass.php" method="POST">
...
if (isset($_POST['submit'])) {
    ...
    $cpassword = $_POST["cpassword"]; // Get the confirm password field
    ...
    if (strlen($password) < $minLength ||
        ...
        $checkUsernameQuery = "SELECT * FROM worker_data1 WHERE username = '$username'";
        ...
        if ($result->num_rows > 0) {
            ...
            $sql = "INSERT INTO worker_data1 (username, password) VALUES ('$username', '$password')";
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                header("Location: signupworkerotherdetails.php");
                exit();
            } 
            else {
